	...
	return (
		<div className="App">
			...
			<div className="resume-item narrow">
				<p>
					I interned at <span className="rainbow-text">Google</span> in 2022, helping Data Commons develop a knowledge graph of over a billion time series.
					<br />
					<br />
			...
			*/}
			...
			<div className="resume-item narrow">
				<p>
					I'm prototyped <span className="rainbow-text">strate.gg</span>, a real-time strategy website for games such as Amazons,
					Mancala, and Chess.

					<br />
					<br />
					<span className="hidden-text">This is a full-stack development project where I developed my skills in automated testing with CI,
			...
			<div className="resume-item narrow">
				<p>
					I interned at <span className="rainbow-text">98point6</span> in 2021, contributing to their mission to provide affordable healthcare.

					<br />
					<br />
					<span className="hidden-text">I designed and implemented a recommender system poised to save 120 physicians-hours per year using Machine Learning.</span>
				</p>
			</div>
