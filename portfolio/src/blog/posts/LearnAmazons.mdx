...
### 1. The board
<SideBySideContent left={`The board is a simple, 10 by 10 square grid. We can assign letters to the columns and 
...
we number the rows 1 through 10, starting from the bottom.`} right={(<SinglePlayerAmazonsBoard></SinglePlayerAmazonsBoard>)}>
</SideBySideContent>
