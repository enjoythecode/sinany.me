                    ...
                    e.exports = (function() {
                        var e = {
                                765: function(e, t) {
                                    ...
                                    o = function(e) {
                                        ...
                                        function n(e, t, o, n, r) {
                                            if (0 === t) return o;
                                            if (1 === t) return n;
                                            for (var l = 2 / e, i = n, s = 1; s < t;
                                                ++s) i = n * s * l + r * o, o = n, n = i;
                                            return i
                                        }
                                ...
                                162: function(e) {
                                    ...
                                    e.exports = (t = function(e, t) {
                                        ...
                                        e.sum = function(e) {
                                            ...
                                            for (var o, n = e.mean(t), r = 0, l = t.length;
                                                --l >= 0;
                                            ) r += (o = t[l] - n) * o;
                                            return r
                                        }, e.sumrow = function(e) {
                                        ...
                                        e.gammaln = function(e) {
                                                ...
                                                for (r = d, n = d < 1 ? d++ : (d -= u = (0 | d) - 1) - 1, o = 0; o < 8;
                                                    ++o) f = (f + i[o]) * n, c = c * n + s[o];
                                                if (l = f / c + 1, r < d) l /= r;
                                                else if (r > d)
                                                    for (o = 0; o < u;
                                                        ++o) l *= d, d++;
                                ...
                                592: function(e, t, o) {
                                    ...
                                    function Z() {
                                        const e = [];
                                        for (let t = 0; t < arguments.length;
                                            ++t) {
                                            let o = !1;
                                            const n = arguments[t];
                                            for (let t = 0; t < e.length && (o = e[t] === n, !o);
                                                ++t);
                                            o || e.push(n)
                                        }
                                        return e
                                    ...
                                    re.DIST.RANGE = (e, t, o, n) => {
                                        ...
                                        let r = 0;
                                        for (let l = o; l <= n; l++) r += Ue(e, l) * Math.pow(t, l) * Math.pow(1 - t, e - l);
                                        return r
                                    }, re.INV = (e, t, o) => {
                                    ...
                                    function ze(e) {
                                        ...
                                        return 0 === t || 1 === t ? 1 : (qe[t] > 0 || (qe[t] = ze(t - 1) * t), qe[t])
                                    }
                                    ...
                                    function Uo(e, t) {
                                        ...
                                        for (let t = 1; t < e[0].length;
                                            ++t) o[t] = !0;
                                        let n = t[0].length;
                                        for (let e = 1; e < t.length;
                                            ++e) t[e].length > n && (n = t[e].length);
                                        for (let r = 1; r < e.length;
                                            ++r)
                                            for (let l = 1; l < e[r].length;
                                                ++l) {
                                                let i = !1,
                                                    s = !1;
                                    ...
                                    t.ABS = function(e) {
                                        ...
                                        return e = zo(e), t = zo(t), o = zo(o), qo(e) && qo(t) && qo(o) ? n <= 0 || r <= 0 || -1 === [1, 2, 4].indexOf(l) || -1 === [0, 1, 2, 3, 4].indexOf(i) || o <= e ? c : (r = r || 0) * n * ft(e, o, i = i || 0) : s
                                    }, t.ACCRINTM = function() {
                                    ...
                                    }, t.CHAR = pt, t.CHIDIST = Pt, t.CHIDISTRT = _t, t.CHIINV = Vt, t.CHIINVRT = Ut, t.CHISQ = le, t.CHITEST = qt, t.CHOOSE = function() {
                                    ...
                                    }, t.COMBIN = Ue, t.COMBINA = function(e, t) {
                                        return E(e = F(e), t = F(t)) || (e < t ? c : 0 === e && 0 === t ? 1 : Ue(e + t - 1, e - 1))
                            ...
                            jexcel = function(el, options) {
                                ...
                                obj.executeFormula = function(expression, x, y) {
                                    ...
                                    var n = parseInt(e),
                                        ...
                                        s = l - n + 1,
                                        a = i - r + 1;
                                    l < n && (e = l.toString(), s = n - l + 1), i < r && (t = i.toString(), a = r - i + 1);
                                    ...
                                    if (null != e && null != t && o) {
                                        for (var b = 0, j = 0, h = [], g = {}, m = {}, v = 0, y = parseInt(e), C = parseInt(t), x = null; x = o[j];) {
                                            for (b = 0, y = parseInt(e); null != x[b];) {
                                                var w = obj.updateCell(y, C, x[b]);
                                                if (h.push(w), obj.updateFormulaChain(y, C, h), f && f[v]) {
                                                    var A = jexcel.getColumnNameFromId([y, C]);
                                                    g[A] = f[v], m[A] = obj.getStyle(A), obj.records[C][y].setAttribute("style", f[v]), v++
                                                }
                                                if (null != x[++b]) {
                                        ...
                                        obj.updateSelectionFromCoords(e, t, y, C), obj.setHistory({
                                            action: "setValue",
                                            records: h,
                                            selection: obj.selectedCell,
                                            newStyle: g,
                                            oldStyle: m
                                        }), obj.updateTable(), obj.dispatch("onpaste", el, o), obj.onafterchanges(el, h)
                                    }
